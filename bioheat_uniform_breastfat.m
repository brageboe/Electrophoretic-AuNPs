function T = bioheat_uniform_breastfat(freq, E0, t, suspension_radius, C_abs, host_permittivity, T0, res) 
    arguments
        freq
        E0
        t
    ...
    c_b = 0;%3622.50;      % specific heat capacity of blood [J/kg/K]. Table 2 [1].
