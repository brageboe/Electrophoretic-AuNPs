function set_standard_plot_style()
    fig=gcf;
    fig.Position = [100, 300, 800, 350]; %Height 400 normal, 350 colorbar, %Width 600 normal, 800 colorbar
    
    fontsize = 20; %16 normal, 20 colorbar, 28 small
    ...
    if ~isempty(C)
        ...
        c.Label.FontSize = 22; %18 normal, 22 colorbar only
