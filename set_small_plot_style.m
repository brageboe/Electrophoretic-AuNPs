function set_small_plot_style()
    fig=gcf;
    % fig.Position = [100, 300, 600, 350]; %Height 400 normal, 350 colorbar, %Width 600 normal, 800 colorbar
    fig.Position = [100, 300, 600, 400];

    fontsize = 22; %16 normal, 20 colorbar, 28 small
    ...
    set(gca,'linewidth',1.5); % Normal 1, small 1.5
    set(gca,'TickLength',[0.03, 0.01]); % Normal 0.02, small 0.03
